...
Если ваши инструименты сборки не предоставляют возможности автоматической сборки сервисворкера в режиме сборки - его необходимо предварительно собрать и затем уже запускать сборку приложения.
