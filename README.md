...
Если ваши инструименты сборки не предоставляют возможности автоматической сборки сервисворкера в режиме сборки и обслуживания приложения - сервисворкер необходимо предварительно собрать и затем уже запускать сборку приложения в dev режиме.
