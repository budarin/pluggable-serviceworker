...
- Клиентские утилиты для работы с SW: регистрация с обходом бага `claim()`, обнаружение новой версии, подписка на сообщения, запрос версии SW, отправка сообщений и проверка поддержки.
