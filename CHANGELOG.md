...
- Документация: ссылка на русскую версию README в английском README заменена на абсолютный URL репозитория, чтобы ссылка работала при просмотре пакета на npm (относительная ссылка давала 404).
